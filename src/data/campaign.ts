...
const joinedAllies = [...soreinAllies, ...nordheimAllies.filter((unit) => unit.unitDefId !== "elara").slice(0, 3)];
...
const outlines: Array<{
  ...
  { id: "ch02", title: "02 焦土村庄", act: "第一幕：相遇与背叛", objective: "护送难民穿过村庄，击退教会审判队。", map: "village", side: "sorein", opening: ["审判官的火把照亮村口，瓦伦丁命令所有人先救人。"], victoryText: ["幸存者低声说，纵火者穿着圣光教会的白袍。"] },
  { id: "ch03", title: "03 断桥阻击", act: "第一幕：相遇与背叛", objective: "守住桥口 3 回合并击退北境追兵。", map: "bridge", side: "sorein", opening: ["断桥只剩一线通路，骑兵无法展开，森林成了真正的敌人。"], victoryText: ["瓦伦丁负伤，他掌心里攥着一枚教会纹章。"] },
  { id: "ch04", title: "04 双线并行", act: "第一幕：相遇与背叛", objective: "切换到艾拉菈视角，救出被南军围捕的族人。", map: "snow", side: "nordheim", opening: ["北境的雪盖不住血迹。艾拉菈第一次让玩家看见战争的另一面。"], victoryText: ["南方人的骑士道，在雪地里显得和谎言一样苍白。"] },
  { id: "ch05", title: "05 雪夜奇袭", act: "第一幕：相遇与背叛", objective: "兄妹阵营正面交锋，任一主角撤退即可过关。", map: "snow", side: "sorein", opening: ["雪夜里，两枚龙痕隔着战场隐隐发烫。"], victoryText: ["没人知道为什么最后一击偏了半寸。"] },
  { id: "ch06", title: "06 血色黎明", act: "第一幕：相遇与背叛", objective: "保护瓦伦丁撤离，击破追击者。", map: "village", side: "sorein", opening: ["黎明像血一样漫过麦田。瓦伦丁说，别相信每一道圣光。"], victoryText: ["瓦伦丁战死，凶器上带着教会纹章。"] },
  { id: "ch07", title: "07 俱虏与对话", act: "第一幕：相遇与背叛", objective: "兄妹被囚，同场越过守卫控制区并会合。", map: "bridge", side: "joined", opening: ["同一个战俘营里，奥德里克和艾拉菈终于交换了名字。"], victoryText: ["敌人的脸变得具体，仇恨第一次迟疑。"] },
  { id: "ch08", title: "08 逃亡之约", act: "第一幕：相遇与背叛", objective: "合力越狱，占领出口。", map: "altar", side: "joined", opening: ["越狱不是同盟，只是同一条路上暂时不能互相杀死。"], victoryText: ["篝火旁，双生动机第一次合在一起。"] },
  { id: "ch09", title: "09 龙痕共鸣", act: "第二幕：真相与撑裂", objective: "调查龙痕祭坛，击退被吸引来的教会军。", map: "altar", side: "joined", opening: ["祭坛回应两人的血，石缝里亮起猩红纹路。"], victoryText: ["两枚圣痕同时灼痛，封印真相露出第一道裂缝。"] },
  { id: "ch10", title: "10 圣都疑云", act: "第二幕：真相与撑裂", objective: "潜入档案馆，夺取双生记录。", map: "village", side: "joined", opening: ["圣都的钟声太整齐，整齐得像审判。"], victoryText: ["档案写着：双生子出生当夜即被分离。"] },
  { id: "ch11", title: "11 弑父真相", act: "第二幕：真相与撑裂", objective: "突破教会封锁，揭开弑父命令。", map: "bridge", side: "joined", opening: ["真相不是钥匙，是刀。它会先割开握住它的人。"], victoryText: ["养父曾奉教会之命杀死两人的生父。"] },
  { id: "ch12", title: "12 禁忌之心", act: "第二幕：真相与撑裂", objective: "护送双生离开伏击圈，保持二人存活。", map: "snow", side: "joined", opening: ["血缘与心意同时落下，任何答案都像背叛。"], victoryText: ["他们没有说出口，但战场已经替他们回答。"] },
  { id: "ch13", title: "13 叛国抉择", act: "第二幕：真相与撑裂", objective: "击退两国追兵，并选择倒向南、北或中立。", map: "bridge", side: "joined", opening: ["没有中立的旗帜，只有愿意为中立流的血。"], victoryText: ["选择被写入世界状态，盟友开始计算离队与留下的代价。"] },
  { id: "ch14", title: "14 旧友为敌", act: "第二幕：真相与撑裂", objective: "击败被洗脑的塞西莉亚，可触发劝降伏笔。", map: "village", side: "joined", opening: ["塞西莉亚举剑时，眼神像被擦掉了一半。"], victoryText: ["旧友没有醒来，但她听见了自己的名字。"] },
  { id: "ch15", title: "15 织命低语", act: "第二幕：真相与撑裂", objective: "在神殿中撑过宗座的三阶段压迫。", map: "altar", side: "joined", opening: ["宗座说：从头到尾，都是我的棋局。"], victoryText: ["神不是答案，神是幕后黑手。"] },
  { id: "ch16", title: "16 众叛亲离", act: "第二幕：真相与撑裂", objective: "在队伍重组中守住撤离点。", map: "snow", side: "joined", opening: ["选择开始收账。有人离队，有人留下，也有人沉默。"], victoryText: ["队伍变小了，但每一步都更像自己的意志。"] },
  { id: "ch17", title: "17 龙脊远征", act: "第二幕：真相与撑裂", objective: "穿越龙脊山脉，占领祭坛入口。", map: "snow", side: "joined", opening: ["龙脊山脉像一条死去的神横在大陆中央。"], victoryText: ["山风里传来古龙低鸣，像在召回自己的血。"] },
  { id: "ch18", title: "18 觉醒代价", act: "第二幕：真相与撑裂", objective: "使用或压制龙痕觉醒，阻止失控。", map: "altar", side: "joined", opening: ["力量给出捷径，也在终点索要灵魂。"], victoryText: ["龙化值成为结局的债。"] },
  { id: "ch19", title: "19 圣都决战", act: "第三幕：献祭与改命", objective: "攻入圣都，击败织命宗座的代行者。", map: "village", side: "joined", opening: ["圣都的大门为战争敞开，也为谎言敞开。"], victoryText: ["宗座倒下前笑了，因为封印仍然需要牺牲。"] },
  { id: "ch20", title: "20 封印真相", act: "第三幕：献祭与改命", objective: "守住封印核心，读取古龙记忆。", map: "altar", side: "joined", opening: ["真相终于完整：封印需要一名龙痕者作为楔子。"], victoryText: ["活下去与拯救世界，不再能同时成立。"] },
  { id: "ch21", title: "21 最后的支援", act: "第三幕：献祭与改命", objective: "全员支援会话收束，抵御最后围剿。", map: "bridge", side: "joined", opening: ["每个人都在黎明前说出最像遗言的话。"], victoryText: ["羁绊不是奖励，是选择时手上的重量。"] },
  { id: "ch22", title: "22 神殿之门", act: "第三幕：献祭与改命", objective: "突入龙神封印核心，击破门前守卫。", map: "altar", side: "joined", opening: ["神殿之门没有锁，因为它一直在等钥匙长大。"], victoryText: ["门开了，世界安静得像屏住呼吸。"] },
  { id: "ch23", title: "23 双生之择", act: "第三幕：献祭与改命", objective: "真正互斥的结局分支：献祭兄、献祭妹或弑神改命。", map: "altar", side: "joined", opening: ["宿命把三条路摆在面前，每一条都要留下些什么。"], victoryText: ["选择落下，结局开始。"] },
  { id: "ch24", title: "24 终幕", act: "第三幕：献祭与改命", objective: "按第 23 章抉择进入对应结局，击破最后形态。", map: "altar", side: "joined", opening: ["最后的战斗不是为了证明谁更强，而是证明命运并非唯一作者。"], victoryText: ["双生的故事在血与光之间收束。"] },
];
